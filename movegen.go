...
//
// NOTE: The order of generated moves must remain unchanged. The precomputed
// Huffman codes are tightly coupled to the indices of legal moves, generated by
// the concrete move generator, so those indices must always be the same.
// Otherwise, the Huffman codes must be recomputed to ensure effective compression.
