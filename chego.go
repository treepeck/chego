...
var (
	...
	// Lookup bishop attack table for every possible combination of square/occuancy.
	BishopAttacks [64][512]uint64
	// Lookup rook attack table for every possible combination of square/occuancy.
